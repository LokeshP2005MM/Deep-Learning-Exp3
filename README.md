...
img = image.load_img('/content/ChatGPT Image Oct 23, 2025, 01_12_00 PM.png')
type(img)

img = image.load_img('/content/ChatGPT Image Oct 23, 2025, 01_14_25 PM.png')
plt.imshow(img)
...
img1 = image.load_img('/content/ChatGPT Image Oct 23, 2025, 01_12_00 PM.png')
plt.imshow(img1)
...
![TRAINING](https://github.com/user-attachments/assets/66de6f13-7a59-426c-836e-fb2f1c541669)

### Training Loss, Validation Loss Vs Iteration Plot:

![TLV](https://github.com/user-attachments/assets/2f421041-d319-46b2-9f2e-e072072696d7)

### Classification Report:

![CLASSI](https://github.com/user-attachments/assets/fb9ac9fc-e2e3-429e-a737-ede0f4bbd2f5)


### Confusion Matrix:
![CONFU](https://github.com/user-attachments/assets/938a8de1-6bbf-44fc-b1f7-9440e1a01d5e)

### New Sample Data Prediction:
![SAMPL DATA](https://github.com/user-attachments/assets/6c2b970c-fb52-4c8f-828b-212e4716a8ea)
